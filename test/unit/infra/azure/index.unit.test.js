...
describe("testing /lib/azure/index.js", function () {
	...
	describe("calling executeDriver -  createNetworkAndSecurityGroup", function () {
		afterEach((done) => {
			sinon.restore();
			nock.cleanAll();
			done();
		...
		it("Success", function (done) {
			...
			let nocks = nock('https://management.azure.com')
				.put(`/subscriptions/4/resourceGroups/testcase/providers/Microsoft.Network/networkSecurityGroups/test-net?api-version=2018-02-01`,
					{
						"location": "centralus",
						"properties": {
							"securityRules": []
			...
			service.createNetworkAndSecurityGroup(options, function (error, response) {
				assert.ifError(error);
				assert.ok(response);
