...
const kubeLib = {
	...
	checkSecrets(options, secrets, cb) {
		if (options.params.inputmaskData.custom.secrets && Array.isArray(options.params.inputmaskData.custom.secrets) && options.params.inputmaskData.custom.secrets.length > 0) {
