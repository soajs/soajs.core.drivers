...
const engine = {
	...
	deployService(options, cb) {
		...
		if(options.params.data.labels['soajs.service.label'].indexOf(options.params.data.labels['soajs.env.code'] + "-") !== 0) {
		...
		if(options.params.data.labels['soajs.service.label'].indexOf("-v" + options.params.data.labels['soajs.service.version']) === -1) {
	...
	rebuildService(deployment, options) {
		...
		if(options.params.newBuild.labels['soajs.service.label'].indexOf(options.params.newBuild.labels['soajs.env.code'] + "-") !== 0) {
		...
		if(options.params.newBuild.labels['soajs.service.label'].indexOf("-v" + options.params.newBuild.labels['soajs.service.version']) === -1) {
