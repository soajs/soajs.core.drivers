...
const engine = {
	...
	deployService(options, cb) {
		...
		if(options.params.data.labels['soajs.service.name'] !== 'controller' && options.params.data.labels['soajs.service.version']){
	...
	rebuildService(deployment, options) {
		...
		if(options.params.newBuild.labels['soajs.service.name'] !== 'controller' && options.params.newBuild.labels['soajs.service.version']){
