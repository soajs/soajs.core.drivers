...
const kubePVCs = require('./persistentvolumeclaims.js');
...
const engine = {
	...
	'getPVC': function(options, cb){
		kubePVCs.getPVC(options, cb);
	},
	
	'createPVC': function(options, cb){
		kubePVCs.createPVC(options, cb);
	},
	
	'deletePVC': function(options, cb){
		kubePVCs.deletePVC(options, cb);
	},
	
	'listPVCs': function(options, cb){
		kubePVCs.listPVCs(options, cb);
	},
