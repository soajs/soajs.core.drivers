...
const swarmPVCs = require('./persistentvolumeclaim');
...
const engine = {
	...
	'getPVC': function(options, cb){
		swarmPVCs.getPVC(options, cb);
	},
	
	'createPVC': function(options, cb){
		swarmPVCs.createPVC(options, cb);
	},
	
	'deletePVC': function(options, cb){
		swarmPVCs.deletePVC(options, cb);
	},
	
	'listPVCs': function(options, cb){
		swarmPVCs.listPVCs(options, cb);
	},
